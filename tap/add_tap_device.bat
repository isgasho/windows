...
::    Windows 7).
set BEFORE_DEVICES=%tmp%\nextdns-installer-tap-devices-before.txt
set AFTER_DEVICES=%tmp%\nextdns-installer-tap-devices-after.txt
...
echo Creating TAP network device...
tapinstall install OemVista.inf %DEVICE_HWID%
if %errorlevel% neq 0 (
